...
Test issue with akka, borer and scala3.

This small test project demonstrates an error with the scala3 compiler, akka or b.
...
I have not found any references to `akka.stream.scaladsl.type.Source` in any of the dependencies or in this code.
